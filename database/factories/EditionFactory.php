...
class EditionFactory extends Factory
{
    public function definition(): array
    {
        return [
            ...
            'title_prefix' => $this->faker->words(5),
            ...
            'edition_name' => $this->faker->words(5),
            ...
            'physical_dimensions' => $this->faker->words(3),
            'physical_format' => $this->faker->words(3),
            'number_of_pages' => $this->faker->words(3),
            'subjects' => json_encode($this->faker->words(3, false)),
            'pagination' => $this->faker->randomDigit(),
            'lccn' => json_encode($this->faker->words(3, false)),
            'ocaid' => $this->faker->words(2),
            ...
            'translation_of' => $this->faker->words(),
